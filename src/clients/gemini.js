...
/**
 * Gets the Gemini CLI config file path based on scope
...
/**
 * Reads the existing Gemini CLI config or returns empty config
...
/**
 * Transforms the generic MCP config to Gemini CLI format
 * @param {MCPServerConfig} config - The generic server config
 * @returns {Record<string, unknown>} Gemini CLI formatted config
 */
...
/**
 * Adds an MCP server configuration to Gemini CLI
 ...
 */
export async function add_to_gemini(config, options) {
